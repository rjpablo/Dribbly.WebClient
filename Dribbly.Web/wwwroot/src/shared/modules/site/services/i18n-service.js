        ...
        .service('i18nService', ['$timeout', 'constants', function ($timeout, constants) {
            ...
            var _entriesTmp = {
                site: {
                    ...
                    'MapMarkerTypeEnum.Custom_0': 'Custom',
                    'MapMarkerTypeEnum.Player_1': 'Player',
                    'MapMarkerTypeEnum.Court_2': 'Court',
                    MobileNo: 'Mobile No.',
                ...
                app: {
                    ...
                    DeleteTournamentGameComfirmationMsg: 'This will delete the game. Do you wish to proceed?',
                    ...
                    Duration: 'Duration',
                    EditPost: 'Edit Post',
                    'EjectionStatusEnum.NotEjected_0': 'Not Ejected',
                    'EjectionStatusEnum.Ejected2FlagrantFouls_1': 'Ejected for committing two Flagrant fouls',
                    'EjectionStatusEnum.EjectedFlagrantFoul2_2': 'Ejected for committing Flagrant Foul 2',
                    'EjectionStatusEnum.EjectedOther_3': 'Ejected',
                    End: 'End',
                    EndGame: 'End Game',
                    ...
                    Error_DeleteGame_AlreadyFinished: 'This game can no longer be deleted because it has already finished',
                    Error_DeleteGame_AlreadyStarted: 'This game can no longer be deleted because it has already started',
                    ...
                    Error_EndGame_Tied: 'Cannot end a tied game.',
                    ...
                    'EntityTypeEnum.Account_0': 'Account',
                    'EntityTypeEnum.Court_1': 'Court',
                    'EntityTypeEnum.Game_2': 'Game',
                    'EntityTypeEnum.Team_3': 'Team',
                    ...
                    'EntityTypeEnum.All_8': 'All',
                    'EntityTypeEnum.Blog_9': 'Blog',
                    'EntityTypeEnum.Event_10': 'Event',
                    ...
                    'GameEventTypeEnum.FreeThrowMissed_14': 'Free Throw Missed',
                    Games: 'Games',
                    ...
                    'GameStatusEnum.Deleted_4': 'Deleted',
                    GameDetails: 'Game Details',
                    Gender: 'Gender',
                    'GetPlayersSortByEnum.OverallScore_0': 'Overall Score',
                    'GetPlayersSortByEnum.PPG_1': 'Points Per Game',
                    'GetPlayersSortByEnum.RPG_2': 'Rebounds Per Game',
                    'GetPlayersSortByEnum.APG_3': 'Assists Per Game',
                    'GetPlayersSortByEnum.FGP_4': 'Field Goal Percentage',
                    'GetPlayersSortByEnum.BPG_5': 'Blocks Per Game',
                    'GetPlayersSortByEnum.TPG_6': '3Pts Per Game',
                    'GetPlayersSortByEnum.SPG_7': 'Steals Per Game',
                    'GetPlayersSortByEnum.ThreePP_8': '3-Point Percentage',
                    'GetPlayersSortByEnum.DateJoined_9': 'Date Joined',
                    Go: 'Go',
                    Height: 'Height',
                    HomeCourt: 'Home Court',
                    'HubConnectionStatusEnum.Connecting_0': 'Connecting',
                    'HubConnectionStatusEnum.Connected_1': 'Connected',
                    'HubConnectionStatusEnum.Reconnecting_2': 'Reconnecting',
                    'HubConnectionStatusEnum.Disconnected_3': 'Disconnected',
                    Id: 'ID',
                    ...
                    Message: 'Message',
                    'MessageRecipientStatusEnum.NotSeen_0': 'Not Seen',
                    'MessageRecipientStatusEnum.Seen_1': 'Seen',
                    Mvps: 'MVPs',
                    New: 'New',
                    NewPost: 'New Post',
                    ...
                    Notification_AssignedAsTimekeeper: 'You\'ve been assigned as Timekeeper for <strong>{gameTitle}</strong>',
                    Notification_ABookingHasBeenMadeForYouAtCourtName: 'A game has been booked for you at <strong>{courtName}</strong>',
                    Notification_JoinedEvent: '<strong>{requestorName}</strong> joined your event <strong>{eventTitle}</strong>',
                    Notification_JoinEventRequest: '<strong>{requestorName}</strong> is requesting to join <strong>{eventTitle}</strong>',
                    Notification_JoinEventRequestApproved: 'Your request to join <strong>{eventTitle}</strong> has been approved.',
                    ...
                    Notification_PostReceivedReaction: '<strong>{reactorName}</strong> liked your post.',
                    ...
                    'NotificationTypeEnum.AssignedAsTimekeeper_4': 'AssignedAsTimekeeper',
                    ...
                    'NotificationTypeEnum.JoinGroupRequest_80': 'JoinGroupRequest',
                    'NotificationTypeEnum.JoinGroupRequestApproved_81': 'JoinGroupRequestApproved',
                    'NotificationTypeEnum.PostReceivedReaction_100': 'PostReceivedReaction',
                    'NotificationTypeEnum.JoinEventRequest_120': 'JoinEventRequest',
                    'NotificationTypeEnum.JoinEventRequestApproved_121': 'JoinEventRequestApproved',
                    'NotificationTypeEnum.JoinedEvent_122': 'JoinedEvent',
                    ...
                    'ShotTypeEnum.FreeThrow_1': 'Free Throw',
                    ...
                    SortBy: 'Sort by',
                    Stages: 'Stages',
                    'StageStatusEnum.NotStarted_1': 'Not Started',
                    'StageStatusEnum.Started_2': 'Started',
                    'StageStatusEnum.Finished_3': 'Finished',
                    Start: 'Start',
                    ...
                    'TimeoutTypeEnum.Full_1': 'Full',
                    'TimeoutTypeEnum.Short_2': 'Short',
                    'TimeoutTypeEnum.Official_3': 'Official',
                    Title: 'Title',
                    Today: 'Today',
                    Tournament: 'Tournament',
                    TournamentNamePrompt: 'Tournament Name',
                    Tournaments: 'Tournaments',
                    TournamentDetails: 'Tournament Details',
                    'TurnoverCauseEnum.Other_0': 'Other',
                    'TurnoverCauseEnum.Stolen_1': 'Stolen',
                    'TurnoverCauseEnum.BadPass_2': 'Bad Pass',
                    'TurnoverCauseEnum.Travelling_3': 'Travelling',
                    'TurnoverCauseEnum.OffensiveFoul_4': 'OffensiveFoul',
                    'TurnoverCauseEnum.ShotClockViolation_5': 'Shot Clock Violation',
                    'TurnoverCauseEnum.OutOfBounds_6': 'Out Of Bounds',
                    'TurnoverCauseEnum.BackcourtViolation_7': 'Backcourt Violation',
                    'TurnoverCauseEnum.ThreeSecondViolation_8': '3-sec Violation',
                    'TurnoverCauseEnum.FiveSecondViolation_9': '5-sec Violation',
